...
object Constants {
    ...
    const val SP_FILE_NAME_BASE = "sp_file_base"
    const val NULL = "NULL"

    // logging
    const val LOG_TAG = "AMIN TAGGGG"

    // Volley
    const val VOLLEY_TIME_OUT = 50000

    // for web names
    const val BASE_URL = "https://pilot.wakecap.com/api/sites/10010001/"
    const val WORKERS_URL = "workers"
    const val AUTH =
